...
--		return v;
--	}
imm8: Z80 -> EnvWithRegisterAndValue
imm8 z80 =
    let
        v = mem z80.pc z80.env
        new_pc = Bitwise.and (z80.pc + 1) 0xFFFF
        env_1 = v.env |> add_cpu_time_env 3
        --z80_1 = { z80 | pc = new_pc } |> add_cpu_time 3
    in
        --IntWithZ80 v.value { z80_1 | env = v.env }
        EnvWithRegisterAndValue new_pc v.value env_1
...
--		return v;
--	}
imm16: Z80 -> EnvWithRegisterAndValue
imm16 z80 =
    let
    ...
    in
        ...
        EnvWithRegisterAndValue pc v.value env
--
--
--	private void rrd()
--	{
...
execute_0x01 z80 =
   ...
   let
      v = imm16 z80
      z80_1 = { z80 | pc = v.register_value, env = v.env }
   in
...
execute_0x11 z80 =
  ...
  let
      v = imm16 z80
      z80_1 = { z80 | env = v.env, pc = v.register_value }
  in
...
execute_0x21 ixiyhl z80 =
  ...
  let
     new_xy = imm16 z80
     z80_1 = { z80 | env = new_xy.env, pc = new_xy.register_value }
...
execute_0x31 z80 =
  ...
  let
      v = imm16 z80
  in
      { z80 | env = v.env, pc = v.register_value, sp = v.value }
...
execute_0x22 z80 =
  ...
  let
     v = imm16 z80
     new_z80 = { z80 | pc = v.register_value }
...
execute_0x06 z80 =
   ...
   let
      new_b = imm8 z80
   in
      { z80 | env = new_b.env, pc = new_b.register_value }|> set_b new_b.value
...
execute_0x0E z80 =
    ...
    let
       ...
       new_c = imm8 z80
    in
       { z80 | env = new_c.env, pc = new_c.register_value, main = { z80_main | c = new_c.value } }
...
execute_0x16 z80 =
    ...
    let
        ...
        new_d = imm8 z80
    in
        { z80 | pc = new_d.register_value, env = new_d.env, main = { z80_main | d = new_d.value } }
...
execute_0x1E z80 =
   ...
   let
      ...
      new_e = imm8 z80
   in
      { z80 | env = new_e.env, pc = new_e.register_value, main = { z80_main | e = new_e.value } }
...
execute_0x26 ixiyhl z80 =
   ...
   let
     value = imm8 z80
     new_z80 = { z80 | env = value.env, pc = value.register_value }
...
execute_0x2E ixiyhl z80 =
  ...
  let
     ...
     h = and xy 0xFF00
     l = imm8 z80
     new_z80 = { z80 | env = l.env, pc = l.register_value }
     new_xy = or h l.value
  in
     set_xy new_xy ixiyhl new_z80
...
execute_0x36 ixiyhl z80 =
    ...
    case ixiyhl of
       HL -> let
                v = imm8 z80
                new_z80 = { z80 | env = v.env, pc = v.register_value }
...
execute_0x30 z80 =
   ...
   if (and z80.flags.ff 0x100) == 0 then
      ...
      let
         v = imm8 z80
      in
         { z80 | env = v.env, pc = v.register_value }
...
execute_0xD3 z80 =
    ...
    let
       value = imm8 z80
       z80_1 = { z80 | env = value.env, pc = value.register_value }
...
execute_0xCD z80 =
   ...
   let
      ...
      pushed = z80_1 |> push v.register_value
   in
...
execute_0xE6 z80 =
   ...
   let
      a = z80 |> imm8
      z80_1 = { z80 | env = a.env, pc = a.register_value }
...
execute_0xFE z80 =
   ...
   in
      { z80 | flags = flags, env = v.env, pc = v.register_value }
...
execute_0xDB z80 =
   ...
   let
      imm8val = z80 |> imm8
      z80_1 = { z80 | env = imm8val.env, pc = imm8val.register_value }
...
group_ed z80_0 =
   ...
   in
      ...
      0x4B -> let
                 v1 = z80 |> imm16
                 z80_1 = { z80 | pc = v1.register_value }
