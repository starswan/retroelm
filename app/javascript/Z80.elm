...
import Loop
import SimpleSingleByte exposing (singleByteFlags, singleByteMainAndFlagRegisters)
...
applyFlagDelta cpu_time z80_flags tmp_z80 =
   let
     ...
     env = tmp_z80.env
     z80 = { tmp_z80 | env = { env | time = cpu_time |> addCpuTimeTime 4 }, interrupts = { interrupts | r = interrupts.r + 1 } }
