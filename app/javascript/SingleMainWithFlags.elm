...
import Z80Address exposing (fromInt, lower8Bits, toInt, top8Bits, top8BitsWithoutShift)
...
singleByteMainAndFlagRegisters =
    Dict.fromList
        ...
        , ( 0xCB44, ( \z80_main z80_flags -> z80_flags |> testBit Bit_0 (z80_main.hl |> top8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        , ( 0xCB45, ( \z80_main z80_flags -> z80_flags |> testBit Bit_0 (z80_main.hl |> lower8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        ...
        , ( 0xCB5C, ( \z80_main z80_flags -> z80_flags |> testBit Bit_3 (z80_main.hl |> top8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        , ( 0xCB5D, ( \z80_main z80_flags -> z80_flags |> testBit Bit_3 (z80_main.hl |> lower8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        ...
        , ( 0xCB64, ( \z80_main z80_flags -> z80_flags |> testBit Bit_4 (z80_main.hl |> top8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        , ( 0xCB65, ( \z80_main z80_flags -> z80_flags |> testBit Bit_4 (z80_main.hl |> lower8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        ...
        , ( 0xCB6C, ( \z80_main z80_flags -> z80_flags |> testBit Bit_5 (z80_main.hl |> top8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        , ( 0xCB6D, ( \z80_main z80_flags -> z80_flags |> testBit Bit_5 (z80_main.hl |> lower8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        ...
        , ( 0xCB74, ( \z80_main z80_flags -> z80_flags |> testBit Bit_6 (z80_main.hl |> top8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        , ( 0xCB75, ( \z80_main z80_flags -> z80_flags |> testBit Bit_6 (z80_main.hl |> lower8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        ...
        , ( 0xCB7C, ( \z80_main z80_flags -> z80_flags |> testBit Bit_7 (z80_main.hl |> top8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        , ( 0xCB7D, ( \z80_main z80_flags -> z80_flags |> testBit Bit_7 (z80_main.hl |> lower8Bits) |> Z80ChangeFlags, IncrementByTwo ) )
        ]
...
inc_h_ix z80_main z80_flags =
    ...
    let
        value =
            inc (top8Bits z80_main.ix) z80_flags
...
inc_h_iy z80_main z80_flags =
    ...
    let
        value =
            inc (top8Bits z80_main.iy) z80_flags
...
dec_h_iy z80_main z80_flags =
    ...
    let
        value =
            dec (top8Bits z80_main.iy) z80_flags
...
ld_indirect_bc_a z80_main z80_flags =
    ...
    Z80ChangeSetIndirect (addr |> fromInt) z80_flags.a increment3
...
rlc_h z80_main z80_flags =
    ...
    let
        value =
            ...
            shifter0 (z80_main.hl |> top8Bits) z80_flags

        new_hl =
            --Bitwise.or (value.value |> shiftLeftBy8) (Bitwise.and z80_main.hl 0xFF)
            Bitwise.or (value.value |> shiftLeftBy8) (lower8Bits z80_main.hl) |> fromInt
    in
...
rlc_l z80_main z80_flags =
    ...
    let
        value =
            ...
            shifter0 (lower8Bits z80_main.hl) z80_flags

        new_hl =
            --Bitwise.or value.value (Bitwise.and z80_main.hl 0xFF00)
            Bitwise.or value.value (top8BitsWithoutShift z80_main.hl) |> fromInt
    in
    FlagsWithHLRegister value.flags new_hl increment0
...
rrc_h z80_main z80_flags =
    ...
    let
        value =
            shifter1 (z80_main.hl |> top8Bits) z80_flags
...
rrc_l z80_main z80_flags =
    ...
    let
        value =
            shifter1 (lower8Bits z80_main.hl) z80_flags
...
rl_h z80_main z80_flags =
    ...
    let
        value =
            shifter2 (z80_main.hl |> top8Bits) z80_flags
...
rl_l z80_main z80_flags =
    ...
    let
        value =
            shifter2 (lower8Bits z80_main.hl) z80_flags
...
rr_h z80_main z80_flags =
    ...
    let
        value =
            shifter3 (z80_main.hl |> top8Bits) z80_flags
...
rr_l z80_main z80_flags =
    ...
    let
        value =
            shifter3 (lower8Bits z80_main.hl) z80_flags
...
sla_h z80_main z80_flags =
    ...
    let
        value =
            shifter4 (z80_main.hl |> top8Bits) z80_flags
...
sla_l z80_main z80_flags =
    ...
    let
        value =
            shifter4 (lower8Bits z80_main.hl) z80_flags
...
sra_h z80_main z80_flags =
    ...
    let
        value =
            shifter5 (z80_main.hl |> top8Bits) z80_flags
...
sra_l z80_main z80_flags =
    ...
    let
        value =
            shifter5 (lower8Bits z80_main.hl) z80_flags
...
sll_h z80_main z80_flags =
    ...
    let
        value =
            shifter6 (z80_main.hl |> top8Bits) z80_flags
...
sll_l z80_main z80_flags =
    ...
    let
        value =
            shifter6 (lower8Bits z80_main.hl) z80_flags
...
srl_h z80_main z80_flags =
    ...
    let
        value =
            shifter7 (z80_main.hl |> top8Bits) z80_flags
...
srl_l z80_main z80_flags =
    ...
    let
        value =
            shifter7 (lower8Bits z80_main.hl) z80_flags
...
bit_1_h z80_main z80_flags =
    z80_flags |> testBit Bit_1 (z80_main.hl |> top8Bits) |> Z80ChangeFlags


bit_1_l : MainWithIndexRegisters -> FlagRegisters -> Z80Change
bit_1_l z80_main z80_flags =
    z80_flags |> testBit Bit_1 (lower8Bits z80_main.hl) |> Z80ChangeFlags
...
bit_2_h z80_main z80_flags =
    z80_flags |> testBit Bit_2 (z80_main.hl |> top8Bits) |> Z80ChangeFlags


bit_2_l : MainWithIndexRegisters -> FlagRegisters -> Z80Change
bit_2_l z80_main z80_flags =
    z80_flags |> testBit Bit_2 (lower8Bits z80_main.hl) |> Z80ChangeFlags
