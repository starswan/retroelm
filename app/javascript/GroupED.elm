...
execute_ED4B rom48k z80 =
  ...
  let
    ...
    z80_1 = { z80 | pc = v1.pc }
    env = z80_1.env
    v2 = { env | time = v1.time } |> mem16 v1.value rom48k
...
execute_ED7B rom48k z80 =
  ...
  let
    v = z80 |> imm16 rom48k
    z80_1 = { z80 | pc = v.pc }
    sp = z80_1.env |> mem16 v.value rom48k
    --env = z80_1.env
  in
...
group_ed rom48k z80_0 =
   let
      ...
      c = z80.env |> m1 z80_0.pc (Bitwise.or z80_0.interrupts.ir (Bitwise.and z80_0.interrupts.r 0x7F)) rom48k
...
rld rom48k z80 =
    let
        v_lhs_1 = z80.env |> mem z80.main.hl rom48k
...
ldir i r rom48k z80 =
   let
      ...
      main = z80.main
      a1 = z80.main.hl
      v1 = z80.env |> mem z80.main.hl rom48k
      env_0 = z80.env
