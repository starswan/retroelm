...
group_ed rom48k z80_0 =
    let
        ...
        c =
            z80.env |> m1 (z80_0.pc |> toInt) (Bitwise.or z80_0.interrupts.ir (Bitwise.and z80_0.interrupts.r 0x7F)) rom48k
...
rld rom48k z80 =
    let
        v_lhs_1 =
            mem (z80.main.hl |> toInt) z80.env.time rom48k z80.env.ram
