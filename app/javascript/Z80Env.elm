...
import CpuTimeCTime exposing (CpuTimeCTime, add_cpu_time_time, c_NOCONT, cont, cont1, cont_port)
...
mem base_addr z80env =
    ...
    in
        Z80EnvWithValue { z80env | time = CpuTimeCTime new_env.cpu_time ctime } value
