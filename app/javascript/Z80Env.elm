         ...
         if addr1 < 0 then
           ...
           let
              ...
              z80env_1 = if addr1 < 0x4000 then
                            z80env |> cont1_env 0 |> cont1_env 3 |> add_cpu_time_env 6
                         else
