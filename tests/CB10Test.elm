            ...
            \_ ->
                let
                    ...
                    mem_value =
                        mem (0x6545 |> fromInt) new_z80.env.time z80rom new_z80.env.ram
                in
                Expect.equal ( addr_int + 2, 0x18 ) ( new_z80.pc |> toInt, mem_value.value )
        , test "0xCB 0x1F RR A" <|
            \_ ->
                let
                    new_env =
