        ...
        [ describe "8 bit loads"
            [ test "0x41 LD B,C" <|
                \_ ->
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x76 ) ( new_z80.pc |> toInt, new_z80.main.b )
            , test "0x44 LD B,H" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x65 ) ( new_z80.pc |> toInt, new_z80.main.b )
            , test "0xDD 0x44 LD B,IXH" <|
                \_ ->
                    ...
                    in
                    Expect.equal ( addr_int + 2, 0x23 ) ( new_z80.pc |> toInt, new_z80.main.b )
            , test "0x48 LD C,B" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x76 ) ( new_z80.pc |> toInt, new_z80.main.c )
            , test "0x53 LD D,E" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x76 ) ( new_z80.pc |> toInt, new_z80.main.d )
            , test "0x5A LD E,D" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x34 ) ( new_z80.pc |> toInt, new_z80.main.e )
            , test "0x5E LD E, (HL)" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x27 ) ( new_z80.pc |> toInt, new_z80.main.e )
            , test "0x60 LD H,B" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x7645 ) ( new_z80.pc |> toInt, new_z80.main.hl |> toInt )
            , test "0x6F LD L,A" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x656F ) ( new_z80.pc |> toInt, new_z80.main.hl |> toInt )
            , test "0x87 ADD A,A" <|
                \_ ->
                    let
                        new_env =
            ...
            , test "0x78 LD A,B" <|
                \_ ->
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x76 ) ( new_z80.pc |> toInt, new_z80.flags.a )
            , test "0xFD 0x60 LD IYH,B" <|
                \_ ->
                    ...
                    in
                    Expect.equal ( addr_int + 2, 0x7645, 0x6545 ) ( new_z80.pc |> toInt, new_z80.main.iy |> toInt, new_z80.main.hl |> toInt )
            , test "0x66 LD H,(HL)" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0x7845 ) ( new_z80.pc |> toInt, new_z80.main.hl |> toInt )
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMem addr 0xDD
                                |> setMem (addr |> incrementBy1) 0x66
                                |> setMem (addr |> incrementBy2) 0x02
                                |> setMem (0x6545 |> fromInt) 0x78
                    ...
                    in
                    Expect.equal ( addr_int + 3, 0x7845, 0x6543 ) ( new_z80.pc |> toInt, new_z80.main.hl |> toInt, new_z80.main.ix |> toInt )
            , test "0x70 LD (HL),B" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr_int + 1, 0xA5 ) ( new_z80.pc |> toInt, mem_value.value )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            mem (0x6545 |> fromInt) new_z80.env.time z80rom new_z80.env.ram
                    in
                    Expect.equal ( addr_int + 3, 0xA5 ) ( new_z80.pc |> toInt, mem_value.value )
            , test "0x74 LD (HL),H" <|
                \_ ->
                    let
                        new_env =
                        ...
                        mem_value =
                            mem (0x6545 |> fromInt) new_z80.env.time z80rom new_z80.env.ram
                    in
                    Expect.equal ( addr_int + 1, 0x65 ) ( new_z80.pc |> toInt, mem_value.value )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            mem (0x6545 |> fromInt) new_z80.env.time z80rom new_z80.env.ram
                    in
                    Expect.equal ( addr_int + 3, 0x25 ) ( new_z80.pc |> toInt, mem_value.value )
